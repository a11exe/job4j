...
public class UserUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            response.getWriter().append(getHtmlEditForm(user));
    ...
    private String getHtmlEditForm(User user) {
        ...
        stringBuilder
                .append("<form method=\"post\" action=\"http://localhost:8080/users/edit\">\n")
                .append("  <div class=\"form-group\">\n")
                .append("    <input type=\"hidden\" name=\"id\" class=\"form-control\" id=\"InputId\" value=\"").append(user.getId()).append("\">\n")
                .append("  </div>\n")
                .append("  <div class=\"form-group\">\n")
                .append("    <label for=\"InputName\">Name</label>\n").append("    <input type=\"text\" name=\"name\" class=\"form-control\" id=\"InputName\" placeholder=\"Enter name\" value=\"").append(user.getName()).append("\">\n")
                .append("  </div>\n")
                .append("  <div class=\"form-group\">\n").append("    <label for=\"InputLogin\">Login</label>\n").append("    <input type=\"text\" name=\"login\" class=\"form-control\" id=\"InputLogin\" placeholder=\"Enter login\" value=\"").append(user.getLogin()).append("\">\n")
                .append("  </div>\n")
                .append("  <div class=\"form-group\">\n").append("    <label for=\"InputEmail\">Email</label>\n").append("    <input type=\"email\" name=\"email\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Email\" value=\"").append(user.getEmail()).append("\">\n")
                .append("  </div>\n")
